...
y = x * 2
while y.data.norm() < 1000:  # .data takes the data of the tensor, .norm takes the euclidean norm.
    y = y * 2
...
y.backward(gradients)  # the argument is kind of a factor to the calculated gradients
